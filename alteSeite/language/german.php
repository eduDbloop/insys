...
/** mambots */
DEFINE('_TOC_JUMPTO','Beitragsinhalt');
...
%s');
DEFINE('_EMAIL_INFO','Beitrag gesendet von');
DEFINE('_EMAIL_SENT','Dieser Beitrag wurde gesendet an');
...
DEFINE('_E_ITEM_INFO','Beitragsinfo');
...
/** content.php */
DEFINE('_SECTION_ARCHIVE_EMPTY','Derzeit gibt es keine archivierten Beitr&auml;ge f&uuml;r diesen Bereich, schauen Sie bitte sp&auml;ter nochmals vorbei');
DEFINE('_CATEGORY_ARCHIVE_EMPTY','Derzeit gibt es keine archivierten Beitr&auml;ge f&uuml;r diese Kategorie, schauen Sie bitte sp&auml;ter nochmals vorbei');
DEFINE('_HEADER_SECTION_ARCHIVE','Bereichs Archiv');
DEFINE('_HEADER_CATEGORY_ARCHIVE','Kategorien Archiv');
DEFINE('_ARCHIVE_SEARCH_FAILURE','Es gibt keine archivierten Beitr&auml;ge f&uuml;r %s %s');	// values are month then year
DEFINE('_ARCHIVE_SEARCH_SUCCESS','Hier sind die archivierten Beitr&auml;ge f&uuml;r %s %s');	// values are month then year
...
DEFINE('_PROMPT_KEYWORD','Suchw&ouml;rter');
...
DEFINE('_SEARCH_SECLIST','Bereich: Liste');
DEFINE('_SEARCH_SECBLOG','Bereich: Blog');
