<?php
$joomfish_componentAdminLang =   "german";			// Which language the component admini should have
$joomfish_noTranslation = 2;			// What to show when no translation available
$joomfish_defaultText = "This site is not available in english";		// Standard text if no translation - only for certain content elements!
