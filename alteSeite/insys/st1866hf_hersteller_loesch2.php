...
$db = mysql_connect($dbhost, $dbuser, $dbpass);
   ...
   if ($auswahl == 0){$sqlab = "delete from insys_hersteller_kochfeld where";
   $sqlab .= " ID = '$ID'";}
	  if ($auswahl == 1){$sqlab = "delete from insys_hersteller_spuele where";
   $sqlab .= " ID = '$ID'";}
...
?>
<br />Zurück zur <a href="st1866hf_hersteller.php?auswahl=<?php echo $auswahl; ?>">&Uuml;bersicht</a>
</td></tr></table>
</body>
</html>
